...
`,
  ...
  },
  {
    title: "Product Pages",
    description:
      "Use these 35 design recommendations to increase your conversion rate & revenue at the product page stage.",
    questions: [
      {
      ...
      },
      {
        ...
        options: [
          {
            optionTitle: `The most desired action on product pages is when users add a product to cart. That's why a prominent CTA-button is one of the essential parts of a product page. Without a prominent CTA-button, the user experience disconnects when shoppers find the product they want to buy.`,
            optionDescription: [],
          },
        ],
      },
      ...
      },
      {
        ...
        options: [
          {
            optionTitle: `What are features? Features are defined as surface statements about your product, such as what it can do, its dimensions, specs, and so on.
...
`,
      ...
      },
      {
        ...
        options: [
          {
            optionTitle: `If you give your shoppers time to think, they can delay making purchases. Sometimes the delay will be short. Sometimes it will be long, so they end up forgetting about the product and the offer altogether.
...
`,
  ...
  },
  {
    title: "Cart Pages",
    description:
      "Use these 21 design recommendations to increase your conversion rate & revenue at the cart page stage.",
    questions: [
      {
        questionTitle:
      ...
      },
      {
        ...
        options: [
          {
            optionTitle: `If you don't do that, when someone wants to change the quantity, they will have to click on the "Update cart" button, which is actually unnecessary if you have an automatic update.
      ...
      },
      {
        ...
        options: [
          {
            optionTitle: `Here is how bad UX looks: If you don't have selectors and don't automatically update the cart, users will have to do 3 unnecessary actions: Click on the quantity input → . Write the desired quantity of items → Click on the "Update cart" button.`,
            optionDescription: [],
          },
        ],
      },
